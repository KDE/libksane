...
#include "KSanePreviewThread.moc"

#include <KDebug>
#include <QMutexLocker>


KSanePreviewThread::KSanePreviewThread(SANE_Handle handle):
QThread(),
...
bool KSanePreviewThread::setPreviewImageSize(const QSize &size)
{
    if (isRunning ()) {
        return false;
    }
...
void KSanePreviewThread::setImageInverted(bool inverted)
{
...
int KSanePreviewThread::scanProgress()
{
    ...
    return (int)(((qreal)bytesRead * 100.0)/m_dataSize);
}
